...
const MaterialColor mainColor = const MaterialColor(
  0xFF151C26,
  const <int, Color>{
    50: const Color(0xFF151C26),
    100: const Color(0xFF151C26),
    200: const Color(0xFF151C26),
    300: const Color(0xFF151C26),
    400: const Color(0xFF151C26),
    500: const Color(0xFF151C26),
    600: const Color(0xFF151C26),
    700: const Color(0xFF151C26),
    800: const Color(0xFF151C26),
    900: const Color(0xFF151C26),
  },
);
