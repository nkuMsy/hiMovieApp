...
class editCommentPage extends StatefulWidget {
  ...
  String title;
  String review;
  editCommentPage({Key key, @required this.id, @required this.title,  @required this.review}) : super(key: key);

  @override
  editCommentState createState() => editCommentState(id, title, review);
}

class editCommentState extends State<editCommentPage> {
  int id;
  String title;
  String review;
  editCommentState(this.id, this.title, this.review);
