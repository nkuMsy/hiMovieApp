import 'package:flutter_template/model/cast_response.dart';
import 'package:flutter_template/model/genre_response.dart';
import 'package:flutter_template/model/movie_detail_response.dart';
import 'package:flutter_template/model/movie_response.dart';
import 'package:dio/dio.dart';
import 'package:flutter_template/model/person_response.dart';
import 'package:flutter_template/model/video_response.dart';

class MovieRepository {
  final String apiKey = "ca2ed587003ec9a4b8d8234c5868e889";
  ...
  var movieSearchUrl = "$mainUrl/search/movie?api_key={api_key}&query=";
  ...
  Future<CastResponse> getSearchMovies(String name) async {
    var params = {
      "api_key": apiKey,
      "language": "en-US"
    };
    try {
      Response response = await _dio.get(movieSearchUrl + "/$name", queryParameters: params);
      return CastResponse.fromJson(response.data);
    } catch (error, stacktrace) {
      print("Exception occured: $error stackTrace: $stacktrace");
      return CastResponse.withError("$error");
